#!/usr/bin/env python3
"""Convenience proxy for stress_test_beam_tracker_loop.py from beamform_project."""
...
_kotekan_script = _charts_root / "kotekan" / "test_charts" / "stress_test_beam_tracker_loop.py"
